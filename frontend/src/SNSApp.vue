...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '주문서', 
                description: 'purchaseorder을 관리하는 화면입니다.', 
                key: 'purchaseorders', 
                route: '/orders/purchaseorders',
                ImageUrl: '',
            },
            { 
                title: 'Delivery', 
            ...
            { 
                title: '상품검색', 
                description: 'serch goods 을 관리하는 화면입니다.', 
                key: 'serchGoods', 
                route: '/orders/serchGoods',
                ImageUrl: '',
            },
